...
export const API_ENDPOINTS = {
  ...
  PROJECT_POST_DETAIL: (projectId, postId) => `${API_BASE_URL}/projects/${projectId}/posts/${postId}`,
  PROJECT_POST_MODIFY: (projectId, postId) => `${API_BASE_URL}/projects/${projectId}/posts/${postId}`,
  PROJECT_POST_LINK: (projectId, postId) => `${API_BASE_URL}/posts/${postId}/link`,
  PROJECT_POST_FILE: (projectId, postId) => `${API_BASE_URL}/posts/${postId}/file/multipart`,
  PROJECT_POST_FILE_MULTIPART: (projectId, postId) => `${API_BASE_URL}/posts/${postId}/file/multipart`,
  ...
  APPROVAL: {
    ...
    FILE_MULTIPART: (approvalId) => `${API_BASE_URL}/approvals/${approvalId}/file/multipart`,
  ...
  DECISION: {
    ...
    FILE_MULTIPART: (decisionId) => `${API_BASE_URL}/decisions/${decisionId}/file/multipart`,
    FILE_COMPLETE: `${API_BASE_URL}/upload/complete`,
